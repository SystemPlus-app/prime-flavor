...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 15,
    available: true,
    description: 'Grilled chicken with Swiss cheese, garlic sauce, vinagrete & potato chips. Choose ciabatta or French roll.',
  },
  {
    id: 'sausage-sandwich',
    name: 'Brazilian Sausage',
  ...
  },
  {
    ...
    price: 15,
    available: true,
    description: 'Mixed green salad with grilled chicken, crispy onions, parmesan cheese, vinaigrette & dried tomato garlic sauce.',
  },
  {
    id: 'picanha-salad',
    name: 'Picanha Salad',
    ...
    price: 21,
    available: true,
    image: '/menu/salada-de-picanha.png',
    description: 'Mixed green salad with sliced picanha, parmesan cheese, crispy onions, vinaigrette & dried tomato garlic sauce.',
  },
  {
    id: 'tropical-salad',
    name: 'Tropical Salad',
    ...
    price: 15,
    available: true,
    description: 'Mixed green salad with mango, crispy onions, parmesan cheese, vinaigrette & dried tomato garlic sauce.',
  },
  {
    id: 'chicken-bacon-salad',
    name: 'Chicken W/ Bacon Salad',
    category: 'salads',
    price: 17,
    available: true,
    image: '/menu/salada-de-frango-com-bacon.png',
    description: 'Mixed green salad with grilled chicken, bacon, crispy onions, parmesan cheese, vinaigrette & dried tomato garlic sauce.',
  },

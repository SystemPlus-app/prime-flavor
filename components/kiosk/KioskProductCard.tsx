...
const productBg: Record<string, string> = {
  ...
  'classic-chicken-salad':   'radial-gradient(ellipse at 50% 60%, #1a3a18 0%, #0d1e0c 50%, #060f06 100%)',
  'picanha-salad':           'radial-gradient(ellipse at 50% 60%, #1a3a18 0%, #0d1e0c 50%, #060f06 100%)',
  'tropical-salad':          'radial-gradient(ellipse at 50% 60%, #1a3a18 0%, #0d1e0c 50%, #060f06 100%)',
  'chicken-bacon-salad':     'radial-gradient(ellipse at 50% 60%, #1a3a18 0%, #0d1e0c 50%, #060f06 100%)',
